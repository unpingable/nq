...
/// Closed compatibility enum for collector families in the composite
/// `nq.witness_packet.v1` runtime. It is transitional debt, not the registry
/// of independently owned check-pack schemas.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
...
/// BSD fact reader — see `nq-check-pack-host::host_bsd`); `Other`
