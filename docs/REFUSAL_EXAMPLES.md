...
The host being up and reporting does not mean every witness you care about is observable on it. Absence of a witness is information, not silence. See [CLAIM_PREFLIGHT_EXISTING_WITNESSES.md](CLAIM_PREFLIGHT_EXISTING_WITNESSES.md) for the underlying rule.
...
- [CLAIM_PREFLIGHT.md](CLAIM_PREFLIGHT.md) — doctrine, including the post-hoc authorization laundering pattern.
...
- [architecture/PATH_TO_1_0.md](architecture/PATH_TO_1_0.md) — what the 1.0 invariants are and why they hold.
