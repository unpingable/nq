...
**Status:** shipped; see [docs/FEATURE_HISTORY.md#finding_export-v1](../FEATURE_HISTORY.md#finding_export-v1) for shipped commits, evidence, and what's unblocked. The Shipped State narrative below remains as design-record content (what was deferred, what was discovered).
