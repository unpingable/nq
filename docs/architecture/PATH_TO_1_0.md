...
- **4a**: operator entry path. Either a new `OPERATOR_GUIDE.md` or a rework of `README.md` + `docs/quickstart.md` so the path from "I just downloaded the binary" to "I have monitoring + receipts working" is one read. Avoid routing through gap docs.
