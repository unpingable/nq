...
- docs/working/gaps/FINDING_DIAGNOSIS_GAP.md (the typed nucleus that consumes features — trajectory.direction was explicitly deferred to this gap)
- docs/working/gaps/STABILITY_AXIS_GAP.md (presence-pattern classification, a simpler version of the persistence feature)
- docs/working/gaps/DOMINANCE_PROJECTION_GAP.md (regime composition would inform projection)
