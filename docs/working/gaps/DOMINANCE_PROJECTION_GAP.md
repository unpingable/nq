...
**Status:** shipped; see [../decisions/FEATURE_HISTORY.md#dominance_projection-v1](../decisions/FEATURE_HISTORY.md#dominance_projection-v1) for evidence. Notification consumer remains explicitly out of V1 scope (spec §"Non-Goals").
...
- docs/working/gaps/FINDING_DIAGNOSIS_GAP.md ("detectors propose, projection elevates")
- docs/working/gaps/STABILITY_AXIS_GAP.md (stability as a projection input)
- docs/working/gaps/GENERALIZED_MASKING_GAP.md (suppression informs projection)
- docs/working/gaps/GENERATION_LINEAGE_GAP.md (coverage as projection context)
