...
- `docs/working/gaps/DASHBOARD_MODE_SEPARATION_GAP.md` — downstream consumer of the Δq participation manifest; live probes inherit non-participatory discipline by design.
- Fix commit: `734f14c` — `publisher: stop opening foreign SQLite DBs — parse file header instead`
- `docs/working/gaps/EVIDENCE_LAYER_GAP.md` (finding pipe)
- `docs/working/gaps/REGIME_FEATURES_GAP.md` (future consumer of composed Δq signals)
