...
- `docs/working/gaps/EVIDENCE_LAYER_GAP.md` — generation and observation substrate whose semantics any backend must preserve.
- `docs/working/gaps/FINDING_EXPORT_GAP.md` — the consumer contract that must remain stable across backends.
- `docs/working/gaps/HISTORY_COMPACTION_GAP.md` — retention and compaction invariants.
- `docs/working/gaps/INSTANCE_WITNESS_GAP.md` — future federated / parent-registry work where backend plurality becomes load-bearing.
