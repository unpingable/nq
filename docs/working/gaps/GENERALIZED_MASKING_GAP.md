...
**Status:** shipped; see [../decisions/FEATURE_HISTORY.md#generalized_masking-v1](../decisions/FEATURE_HISTORY.md#generalized_masking-v1) for evidence (V1.0 + V1.1 witness-scope extension via TESTIMONY_DEPENDENCY).
...
- docs/working/gaps/EVIDENCE_LAYER_GAP.md (transactional substrate this builds on)
- docs/working/gaps/GENERATION_LINEAGE_GAP.md (suppression count is tracked per generation)
