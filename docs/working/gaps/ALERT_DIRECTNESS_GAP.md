...
- `docs/working/gaps/ALERT_INTERPRETATION_GAP.md` — state_kind lane ordering; this gap adds a second-axis sort within each lane
- `docs/working/gaps/FINDING_DIAGNOSIS_GAP.md` — the typed finding nucleus
- `docs/working/gaps/EVIDENCE_RETIREMENT_GAP.md` — basis_state; directness annotates orthogonally
- `docs/working/gaps/COMPLETENESS_PROPAGATION_GAP.md` — partiality propagation; directness must not be blunted by completeness machinery
- `docs/working/gaps/REGIME_FEATURES_GAP.md` — temporal features; most `temporal` detectors consume these
- `docs/working/gaps/STABILITY_AXIS_GAP.md` — stability/flickering/recovering axis overlaps with `temporal` directness
