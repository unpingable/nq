...
- `docs/working/gaps/OBSERVER_DISTORTION_GAP.md` — Δq discipline that live probes inherit. The participation manifest vocabulary applies directly to the probe framework.
...
- `docs/working/gaps/EVIDENCE_LAYER_GAP.md` — snapshot rows carry generation_id + observed_at. The renderer already has the information it needs; this gap is about using it correctly.
