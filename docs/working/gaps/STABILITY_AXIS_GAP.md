...
**Status:** shipped; see [../decisions/FEATURE_HISTORY.md#stability_axis-v1](../decisions/FEATURE_HISTORY.md#stability_axis-v1) for evidence (migration 028 + computation pass + 7 acceptance tests).
...
- docs/working/gaps/FINDING_DIAGNOSIS_GAP.md (the typed nucleus this supplements)
- docs/working/gaps/EVIDENCE_LAYER_GAP.md (finding_observations is the data source for flickering detection)
- docs/working/gaps/GENERATION_LINEAGE_GAP.md (per-generation coverage feeds context)
- docs/working/gaps/GENERALIZED_MASKING_GAP.md (suppression interaction)
