...
**Status:** shipped (V1, 2026-04-30); see [../decisions/FEATURE_HISTORY.md#operational_intent_declaration-v1](../decisions/FEATURE_HISTORY.md#operational_intent_declaration-v1) for evidence (migrations 041-043 + declarations.rs loader/hygiene + apply_declaration_overlay + v_admissibility fork + 4 hygiene detectors). Ratified 2026-05-07. V1 narrowing notes below remain canonical for the spec-vs-shipped diff.
