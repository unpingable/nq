...
- **Slice A — SHIPPED 2026-07-01.** Evidence tombstones: deletion is a receipted act. Shipped state and evidence pointers live in the ledger: [`../decisions/FEATURE_HISTORY.md`](../decisions/FEATURE_HISTORY.md) § `NQ_CLOSE_002_SLICE_A` (migration 061 + `retention.rs`). Closes acceptance criteria 2 (receipted deletion of the sample/rollup cascade), 5 (observable sweep), 6 (no silent purge path).
