...
**Status:** `candidate` / recognition. **Slice handle: NQ-CLOSE-002.** Ranked #2 in the closure stack (most expensive to retrofit; decide retention windows per rung NOW while corpus is small). No build authorized.
