...
**Status:** shipped; see [../decisions/FEATURE_HISTORY.md#generation_lineage-v1](../decisions/FEATURE_HISTORY.md#generation_lineage-v1) for evidence (migration 026 + counter computation in `update_warning_state_inner` + 6 acceptance tests). Ratified 2026-05-07.
...
- docs/working/gaps/EVIDENCE_LAYER_GAP.md (the prerequisite)
