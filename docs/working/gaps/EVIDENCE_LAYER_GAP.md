...
**Status:** shipped; see [../decisions/FEATURE_HISTORY.md#evidence_layer-v1](../decisions/FEATURE_HISTORY.md#evidence_layer-v1) for evidence (migration 025 + `compute_finding_key` + transactional `update_warning_state` + 7 acceptance tests). Ratified 2026-05-07.
...
- docs/architecture/OVERVIEW.md (current — to be replaced by docs/architecture/STORAGE.md)
