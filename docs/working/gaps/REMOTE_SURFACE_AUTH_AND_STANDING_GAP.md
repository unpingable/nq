...
**Blocks:** the doctrinally honest version of any remote NQ surface beyond tonight's Caddy tourniquet; the safe staging of `nq query` from local CLI to remote-accessible runner; the eventual cross-NQ federation work.
**Filed:** 2026-05-27
