...
**Status:** partial — V1.0 substrate (basis lifecycle columns + propagation + export envelope) shipped 2026-04-22; **retirement verb shipped 2026-07-01** (`nq-monitor source retire/unretire` + `sources_retired` + the publish guard that makes retirement stick against re-detection). Remaining V1 follow-on slices: basis-stale detector, render distinction, per-state notification gating. See [../decisions/FEATURE_HISTORY.md#evidence_retirement-v1-0-substrate](../decisions/FEATURE_HISTORY.md#evidence_retirement-v10-substrate). Ratified 2026-05-07.
