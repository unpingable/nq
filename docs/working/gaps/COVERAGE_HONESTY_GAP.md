...
**Status:** shipped (V1, 2026-04-28 → 2026-04-30); see [../decisions/FEATURE_HISTORY.md#coverage_honesty-v1](../decisions/FEATURE_HISTORY.md#coverage_honesty-v1) for evidence (V1.0 schema + finding-kind vocabulary + 5 round-trip tests; V1.1 JSON export wiring + 4 tests; V1.2 composition validation + 6 tests; cross-axis composition under TESTIMONY_DEPENDENCY V1.1). Ratified 2026-05-07. Cross-axis correlation, real-producer adapter, dashboard rendering remain deferred per spec non-goals / V1 boundary; the Shipped State section below stays canonical for the V1 sub-version map.
