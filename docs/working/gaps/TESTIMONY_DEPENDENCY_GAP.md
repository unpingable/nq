...
**Status:** shipped (V1, 2026-04-28 → 2026-04-29); see [../decisions/FEATURE_HISTORY.md#testimony_dependency-v1](../decisions/FEATURE_HISTORY.md#testimony_dependency-v1) for evidence (V1.0 host-masking extension + V1.1 `v_admissibility` view + V1.1 export wire surface + V1.2 paired `node_unobservable` + producer_ref). Ratified 2026-05-07. Multi-level ancestry and role-derived severity are explicitly deferred per V1 non-goals; the Shipped State section below remains canonical for the V1 sub-version map.
