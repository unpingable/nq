...
**Status:** shipped; see [../decisions/FEATURE_HISTORY.md#finding_diagnosis-v1](../decisions/FEATURE_HISTORY.md#finding_diagnosis-v1) for shipped commits, evidence, and what's unblocked. The Shipped State narrative below remains as design-record content (what was deferred, what was discovered).
...
- docs/working/gaps/EVIDENCE_LAYER_GAP.md
- docs/working/gaps/GENERATION_LINEAGE_GAP.md
- docs/working/gaps/GENERALIZED_MASKING_GAP.md (the masking work needs typed shape eventually)
