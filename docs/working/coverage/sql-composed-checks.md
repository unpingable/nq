...
- [`../CLAIM_ADMISSIBILITY_MATTERS.md`](../../theory/CLAIM_ADMISSIBILITY_MATTERS.md) — why the altitude stack matters at all.
- [`../CLAIM_PREFLIGHT.md`](../decisions/CLAIM_PREFLIGHT.md) — where suspicions become refusable claims.
- [`../VERDICTS.md`](../../operator/VERDICTS.md) — the closed eight-verdict set SQL composition does NOT extend.
