...
- **Does not promote any pending keeper or doctrine** into the spine. The sixth-keeper proposal in [NQ_ON_NQ_OPERATIONAL_CLAIMS_GAP](../gaps/NQ_ON_NQ_OPERATIONAL_CLAIMS_GAP.md) remains candidate. **2026-05-28 cross-ref:** that sixth-keeper is the NQ-side local instance of the cross-component pattern in [`~/git/cartography/coordination/SELF-SUBJECT-COLLAPSE.md`](file:///home/jbeck/git/cartography/coordination/SELF-SUBJECT-COLLAPSE.md) (three forcing instances: NS heartbeat-shaped, NQ-on-NQ substrate-state-shaped, agent_gov basis-discipline-shaped). Cross-component recognition is *not* promotion; the sixth-keeper proposal stays candidate locally.
