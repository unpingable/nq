...
**Parent doctrine:** [`SPINE_AND_ROADMAP.md`](../../../architecture/SPINE_AND_ROADMAP.md) (the five-layer spine), [`CLAIM_CUSTODY.md`](../../../architecture/CLAIM_CUSTODY.md) (the keepers).
...
- **Does not introduce a new wire contract.** `nq.preflight.sqlite_wal_state.v1` is a per-kind schema, additive on the same pattern as the other three. Unified `nq.preflight_result.v1` remains deferred per [SPINE_AND_ROADMAP §seams](../../../architecture/SPINE_AND_ROADMAP.md).
...
- [`SPINE_AND_ROADMAP.md`](../../../architecture/SPINE_AND_ROADMAP.md) — the five-layer spine + roadmap; this kind extends Phase 1.
- [`CLAIM_CUSTODY.md`](../../../architecture/CLAIM_CUSTODY.md) — the keepers this slice preserves.
